...
def test_cd_over_bd_less_than_twenty_percent():
    #test cd bigger than bd, but not over 20%, in this condition,
    #xxx_time(cd,bd,t) will equals xxx_time(bd,bd,t)
    time=arrow.now()
    assert acp_times.open_time(205,200,time)==time.shift(hours=5,minutes=53)
    assert acp_times.close_time(205,200,time)==time.shift(hours=13,minutes=30)

def test_cd_0_200():
    #test 0<cd<=200, and a special case cd=200.
    time=arrow.now()
...
def test_cd_200_400():
    #test 200<cd<=400, and special cases cd=300,400.
    time=arrow.now()
    assert acp_times.open_time(315,1000,time)==time.shift(hours=9,minutes=29)
    assert acp_times.close_time(315,1000,time)==time.shift(hours=21)
...
def test_cd_400_600():
    #test 400<cd<=600, and special cases cd=600.
    time=arrow.now()
...
def test_cd_600_1000():
    #test 600<cd<=1000, and special cases cd=1000.
    time=arrow.now()
